...
NAN_METHOD(NJSEthereumLikeTransactionBuilder::setCorrelationId) {

    //Check if method called with right number of arguments
    if(info.Length() != 1)
    {
        return Nan::ThrowError("NJSEthereumLikeTransactionBuilder::setCorrelationId needs 1 arguments");
    }
    ...
    if(!cpp_impl)
    {
        return Nan::ThrowError("NJSEthereumLikeTransactionBuilder::setCorrelationId : implementation of EthereumLikeTransactionBuilder is not valid");
    }
