...
NAN_METHOD(NJSTezosLikeTransactionBuilder::setCorrelationId) {

    //Check if method called with right number of arguments
    if(info.Length() != 1)
    {
        return Nan::ThrowError("NJSTezosLikeTransactionBuilder::setCorrelationId needs 1 arguments");
    }
    ...
    if(!cpp_impl)
    {
        return Nan::ThrowError("NJSTezosLikeTransactionBuilder::setCorrelationId : implementation of TezosLikeTransactionBuilder is not valid");
    }
